...
! ngrid, maxout, maxint,int1: key parameters for the computation of the nonhydrostatic pressure.
 ...
 INTEGER,PARAMETER                  :: NI=256,  NJ=320, NK=64,ngrid=5,maxout=6313128,    maxint=5991680,    int1=5742880
!  INTEGER,PARAMETER                  :: NI=24,  NJ=24, NK=24,ngrid=3,maxout=20832,   maxint=15768,   int1=13824
! INTEGER,PARAMETER                  :: NI=24,  NJ=24, NK=48,ngrid=3,maxout=39792,   maxint=31536,   int1=27648
...
! INTEGER,PARAMETER                  :: NI=96,  NJ=192,NK=24,ngrid=4,maxout=575132,  maxint=505440,  int1=442368
 ...
 !INTEGER,PARAMETER                  :: NI=72,NJ=48,NK=32,ngrid=4,maxout =   286892, maxint =   252720,int1=  221184
!INTEGER, PARAMETER :: NI=      96,NJ=      96,NK=      32,ngrid=       4,maxout =   379472, maxint =   336960,int1=  294912
 !INTEGER, PARAMETER :: NI=     144,NJ=      48,NK=      32,ngrid=       4,maxout =   289112, maxint =   252720,int1=  221184
